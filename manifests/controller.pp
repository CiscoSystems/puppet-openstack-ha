#
# This can be used to build out an openstack controller
#
# === Parameters
#
...
# [memcached_servers]   set memcached_servers flag in nova.conf.  Needed for console_auth to use memcahced.
...
class openstack-ha::controller (
  ...
  # Galera
  $galera		   = true,
  $galera_cluster_name     = 'galera_openstack',
  ...
  class { 'openstack::keystone':
    ...
    glance_internal_address  => $keystone_host,
    glance_admin_address     => $keystone_host,
    nova_public_address      => $keystone_host,
    nova_internal_address    => $keystone_host,
    nova_admin_address       => $keystone_host,
    cinder_public_address    => $keystone_host,
    cinder_internal_address  => $keystone_host,
    cinder_admin_address     => $keystone_host,
    quantum_public_address   => $keystone_host,
    quantum_internal_address => $keystone_host,
    quantum_admin_address    => $keystone_host,
  }
